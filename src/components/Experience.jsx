...
function Experience() {
  return (
    <div className="bg-[#020917] w-full mt-[-5rem] pt-[10rem] h-[auto] flex-col relative z-[2] px-[25px] pb-[5rem] rounded-b-[5rem]">
      <div className="pathimg w-[100%] flex flex-col items-center justify-center">
        ...
        <div className="headline mt-7 flex  flex-col items-center text-[2rem]">
          <span className="text-2xl">An Amazing App Can Change Your Daily Life</span>
          <span>
            <b>Music Experience</b>
          </span>
        </div>
        <div className="features lg:flex lg:flex-row flex-col justify-between gap-5 space-y-10 mt-10 items-center px-[5rem]">
