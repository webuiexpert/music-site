...
function Hero() {
  return (
    <div className="wrapper bg-[#081730] w-full flex lg:flex-row flex-col  min-h-[30rem] rounded-b-[5rem] px-[5rem]   justify-between lg:items-center items-start relative z-[3]">
      <div className="heading flex flex-col justify-center items-start text-[3rem] w-1/2">
        <span className="">Experience The</span>
        <span className=""><b>Best Quality Music</b></span>
